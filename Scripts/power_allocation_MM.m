...
for t=1:max_iter
    ...
    for j=1:N   % Calculate Eq. (12) for each user
        ...
        R_tilde_2 = Bandwidth*log2(R_tilde_2_sum + Sigma_n^2); % second term of Eq. (12)
        R_tilde_1 = Bandwidth*log2(R_tilde_1_sum + Sigma_n^2); % first term of Eq. (12)
